...
public class OrderService {
    ...
    public List<Order> findIdAndDate(String registerDay, Integer id ) {
		...
		//Instancia de objeto para formatear la fecha tomada del endpoint
		DateTimeFormatter formatoFecha = DateTimeFormatter.ofPattern("yyyy-MM-dd");
		//Instancia de objeto tipo fecha local para hacer coincidir la fecha en la maquina de producción
